...
- Add type definitions to `@base58fun/shared` for cross-package code
...
- **Discord:** [Community Server](https://discord.gg/base58fun)
...
Thank you for contributing to base58fun! 🎉
