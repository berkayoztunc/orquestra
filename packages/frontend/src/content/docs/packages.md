...
`@orquestradev/signer-mcp` · [View on npm](https://www.npmjs.com/package/@orquestradev/signer-mcp)

MCP server for signing Solana transactions and messages using any backend supported by [`@solana/keychain`](https://github.com/solana-foundation/solana-keychain). This is what powers the `orquestra-signer` agent skill.
...
## n8n Solana Signer Node

`@orquestradev/n8n-nodes-solana-signer` · [View on npm](https://www.npmjs.com/package/@orquestradev/n8n-nodes-solana-signer)
